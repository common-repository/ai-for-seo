...
const AI4SEO_ENHANCED_REPORTING_INPUT_NAME = "ai4seo-enhanced-reporting-checkbox";
...
echo "<form method='post' class='ai4seo-form'>";
    ...
    echo "<div class='card ai4seo-form-section'>";
        ...
        if (in_array($ai4seo_this_setting_name, $ai4seo_my_changeable_settings_names)) {
            $ai4seo_this_setting_input_name = "ai4seo_{$ai4seo_this_setting_name}";
            $ai4seo_this_setting_input_value = ai4seo_get_setting($ai4seo_this_setting_name);
            $ai4seo_this_setting_description = __("If you are targeting a specific language or region, please select the appropriate language. Choose 'Automatic' to let the AI use your WordPress language (<strong>%s</strong>). Currently, 'AI for SEO' cannot determine the context in which the media is used; therefore, fully automatic language selection, as provided for metadata generation, is not available yet but will be in a future release of this plugin.", "ai-for-seo");
